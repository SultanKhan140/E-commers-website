...
urlpatterns = [
    ...
    path('cartItem/', cart_item_list),
    path('cartItem/<int:pk>', cartItem_by_cart_id),
    path('cartItem/id/<int:pk>', cartItem_by_id),
    path('cartItemDetectSameItem/<int:cartId>/<int:productId>',
         cartitem_detect_same_product),
    ...
    path('filter/price_and_rating/<int:minprice>/<int:maxprice>/<int:rating>/',
         filter_price_and_rating),
    path('filter/price_and_condition/<int:minprice>/<int:maxprice>/<str:condition>/',
         filter_price_and_condition),
    path('filter/<int:minprice>/<int:maxprice>/<int:rating>/<str:condition>/',
         filter_all),
